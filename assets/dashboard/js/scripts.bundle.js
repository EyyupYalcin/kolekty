...
var KTHeader = function(elementId, options) {
    ...
    var Plugin = {
        ...
        /**
         * Reset header
         * Bu eventi bypass ettim. scroll_no_no_no yazdım. Çünkü ekranın en altına gelince bir titreşim yapıyordu olası yan etki için not ediyorum
         * @returns {KTHeader}
         */
        build: function() {
            ...
            window.addEventListener('scroll_no_no_no', function() {
                var offset = 0,
                    st, attrName;
