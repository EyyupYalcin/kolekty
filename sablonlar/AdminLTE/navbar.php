...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="GeriBildirim" class="nav-link">Geri Bildirim</a>
        </li>
    </ul>
            ...
            ?>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        ...
                        <span class="badge badge-danger navbar-badge"><?= okunmamisMesajSayisi($kullanici['id']); ?></span>
                    </a>
            ...
            ?>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        ...
                        <span class="badge badge-warning navbar-badge"><?= gorulmemisBildirimSayisi($kullanici['id']); ?></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
