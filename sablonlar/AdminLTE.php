...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <?php include sablonBileseni('navbar');?>
        <?php include sablonBileseni('sidebar');?>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"><?= $baslik ?></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#"><?= $baslik ?></a></li>
                                <?= isset($alt_baslik) ? " <li class='breadcrumb-item active'>$baslik</li>" : "" ?>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
        ...
        <?php include sablonBileseni('controlSidebar');?>

        <?php include sablonBileseni('footer');?>
