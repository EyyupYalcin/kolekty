          ...
          <div class="card-body pt-4">
            ...
            <div class="d-flex align-items-center">
              ...
              >
                ...
                <div
                  class="profil_resmi symbol-label"
                  style="background-image:url('<?= $kullanici['profil_resmi'] != null ? $kullanici['profil_resmi'] : 'assets/dashboard/media/users/default.jpg' ?>"
                >
              ...
              <div>
                <a
                  ...
                  "
                  ><?= $kullanici['isim'] . " " . $kullanici['soyisim'] ?></a
                >
                <div class="text-muted"><?= $profil_rol ?></div>
                <div class="mt-2">
                  <a
                    href="#"
                    class="
                ...
                <div class="d-flex flex-wrap align-items-center mb-10">
                  ...
                  <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                    ...
                    <span class="text-muted font-weight-bold font-size-sm my-1"
                      >Local, clean &amp; environmental</span
                    >
                        ...
                        <li class="navi-item">
                          <a href="#" class="navi-link">
                            ...
                            <span class="navi-label">
                              <span
                                class="
                                  label label-light-success label-rounded
                                  font-weight-bold
                                "
                                >5</span
                              >
              ...
              <div class="card-body pt-0">
                ...
                <div class="mb-6">
                  ...
                  <div class="d-flex align-items-center flex-grow-1">
                    ...
                    <label
                      class="
                        checkbox checkbox-lg checkbox-lg
                        flex-shrink-0
                        mr-4
                      "
                    >
...
<script>
    $('.profil_resmi .plus_icon').click(function(){ $('#imgupload').trigger('click'); });
