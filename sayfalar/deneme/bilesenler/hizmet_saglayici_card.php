    ...
    ?>
        <div class="product-grid">
            <div class="product-image">
                ...
                <div style="background: url('<?= $hizmet_saglayici['kapak_fotografi'] ?>'); background-size: cover; height: 200px; border-radius: .25rem .25rem 0 0; background-position: center center;"></div>
                </a>
            ...
            <div class="product-content">
                ...
                <h3 class="title"><a href="/<?= $hizmet_adi ?>/<?= seoURL($hizmet_saglayici['adi']) ?>/<?= $hizmet_saglayici['id'] ?>"><?= $hizmet_saglayici['adi'] ?></a></h3>
                <div class="price"><?= $hizmet_saglayici['saatlik_ucret'] ?> ₺</div>
                <div style="display: block;">
                    <a class="add-to-cart" href="#">Hizmet Al</a>
                    <a class="add-to-cart" href="#">Soru Sor</a>
                </div>
