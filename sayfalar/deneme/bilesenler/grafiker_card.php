...
<?php 
function grafiker_card($grafiker){
    ?>
        <div class="product-grid">
            <div class="product-image">
                <a href="/Grafiker/<?= seoURL($grafiker['adi']) ?>/<?= $grafiker['id'] ?>" class="image">
                <div style="background: url('<?= $grafiker['kapak_fotografi'] ?>'); background-size: cover; height: 200px; border-radius: .25rem .25rem 0 0; background-position: center center;"></div>
                </a>
            ...
            <div class="product-content">
                ...
                <h3 class="title"><a href="/Grafiker/<?= seoURL($grafiker['adi']) ?>/<?= $grafiker['id'] ?>"><?= $grafiker['adi'] ?></a></h3>
                <div class="price"><?= $grafiker['saatlik_ucret'] ?> ₺</div>
