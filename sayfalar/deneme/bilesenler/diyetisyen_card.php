...
<?php 
function diyetisyen_card($diyetisyen){
    ?>
        <div class="product-grid">
            <div class="product-image">
                <a href="/Diyetisyen/<?= seoURL($diyetisyen['adi']) ?>/<?= $diyetisyen['id'] ?>" class="image">
                <div style="background: url('<?= $diyetisyen['kapak_fotografi'] ?>'); background-size: cover; height: 200px; border-radius: .25rem .25rem 0 0; background-position: center center;"></div>
                </a>
            ...
            <div class="product-content">
                ...
                <h3 class="title"><a href="/Diyetisyen/<?= seoURL($diyetisyen['adi']) ?>/<?= $diyetisyen['id'] ?>"><?= $diyetisyen['adi'] ?></a></h3>
                <div class="price"><?= $diyetisyen['saatlik_ucret'] ?> ₺</div>
...
function diyetisyen_card($diyetisyen){
    ?>
    <a href="/Diyetisyen/<?= seoURL($diyetisyen['adi']) ?>/<?= $diyetisyen['id'] ?>">
        <div class="card shadow-lg mt-2 mb-2">
            <div class="widget-header card-widget" style="position: relative;">
                ...
                ?>
                <h3 onclick="location.href = '/Diyetisyen/<?= seoURL($diyetisyen['adi']) ?>/<?= $diyetisyen['id'] ?>';" class="p-2 text-bold hizmet-title text-white bg-dark"><?= $diyetisyen['adi'] ?></h3>
            </div>
