                ...
                <div class="d-flex">
                    ...
                    <div class="flex-shrink-0 mr-7 mt-lg-0 mt-3">
                        <div class="symbol symbol-50 symbol-lg-120">
                            <img src="<?= $hizmet_saglayici['profil_fotografi'] ?>" alt="image">
                        </div>
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex justify-content-between flex-wrap mt-1">
                            ...
                            <div class="my-lg-0 my-3">
                                ...
                                <a  class="btn btn-sm btn-info font-weight-bolder text-uppercase"
                                    onclick="istemci_durumu.oturum_acik_mi ? hizmet_al_popup(this) : oturum_popup()"
                                    data-hizmet_adi="<?= $hizmet_saglayici['adi'] ?>"
                                    data-hizmet_tanitim="<?= htmlspecialchars($hizmet_saglayici['tanitim']) ?>"
                                    data-hizmet_id="<?= $hizmet_saglayici['id'] ?>"
                                    data-ucret="<?= $hizmet_saglayici['saatlik_ucret'] ?>"
                                    ...
                                    data-hizmet_saglayici_kapak_fotografi="<?= $hizmet_saglayici['kapak_fotografi'] ?>"
                                    >Hizmet Al</a>
                            </div>
                        </div>
                        <!--end::Title-->
                        ...
                        <div class="d-flex flex-wrap justify-content-between mt-1">
                            <div class="d-flex flex-column flex-grow-1 pr-8">
                                ...
                                <span class="font-weight-bold text-dark-50 kisa_metin scroll scroll-pull" data-scroll="true"><?= $hizmet_saglayici['tanitim'] ?></span>
                            </div>
