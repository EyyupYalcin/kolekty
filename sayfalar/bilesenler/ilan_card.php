...
<?php 
function ilan_card($hizmet_adi, $ilan, $yorum_sayisi){
    global $kullanici;
    ?>
        <style>
                ...
                <div id="ilan_card" class="d-flex">
                    ...
                    <div class="flex-shrink-0 mr-7 mt-lg-0 mt-3 text-center">
                        <div class="symbol symbol-120 hizmet_photo_wrapper">
                            ...
                            <img id="hizmet_photo" src="<?= $ilan['profil_resmi'] ?>" alt="image">
                        </div>
                        <br>
                        <a id="HizmetAlBtn" class="btn btn-sm btn-info font-weight-bolder text-uppercase"
                            ...
                            data-hizmet_adi="<?= $ilan['adi'] ?>"
                            data-hizmet_tanitim="<?= $ilan['tanitim'] ?>"
                            data-hizmet_id="<?= $hizmet_saglayici['id'] ?>"
                            data-hizmet_saglayici_id="<?= $ilan['kullanici_id'] ?>"
                            data-hizmet_saglayici_adi="<?= $ilan['isim'] . " " . $ilan['soyisim'] ?>"
                            data-hizmet_saglayici_profil_resmi="<?= $ilan['profil_resmi'] ?>">Teklif Ver
                        </a>
                    </div>
                    <!--end::Pic-->
                    <!--begin::Info-->
                    <div class="flex-grow-1 position-relative">
                        <?= $ilan['musteri_id'] == $kullanici['id'] ? "<i id='profil_card_duzenle_" . $params['id'] ."' class='profil_card_duzenle fa fa-edit icon-lg'></i>" : "" ?>
                        <!--begin::Title-->
                        <div id="ilan_card_title" class="d-flex justify-content-between flex-wrap mt-1">
                            <div class="d-flex mr-3">
                                <a id="profile_card_hizmet_adi" autocomplete="off" spellcheck="false" href="/<?= $hizmet_adi ?>/<?= seoURL($ilan['adi']) ?>/<?= $ilan['id'] ?>" class="text-dark-75 text-hover-primary font-size-h5 font-weight-bold mr-3"><?= $ilan['baslik'] ?></a>
                            </div>
                        </div>
                        <!--end::Title-->
                        <!--begin::Content-->
                        <div class="d-flex flex-wrap justify-content-between mt-1">
                            <div class="d-flex flex-column flex-grow-1 pr-8">
                                <div class="d-flex flex-wrap mb-4">
                                    ...
                                    <a href="/Profil/<?= $ilan['kullanici_id'] ?>" class="text-dark-50 text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                ...
                                <span id="hizmet_tanitim" spellcheck="false" autocomplete="off" class="font-weight-bold text-dark-50 kisa_metin scroll scroll-pull"><?= nl2br($ilan['icerik']) ?></span>
                            </div>
            
                        </div>
                        <!--end::Content-->
                    </div>
                    <div id="ilan_card_icons" class="d-flex flex-wrap mt-1" style="flex-direction: column; justify-content: space-around;">
                        <div class="row">
...
$('.profil_card_duzenle').on('click', function(event){
    ...
    if(event.target.className.indexOf('edit') >= 0){
        ...
        $('#ilan_card')[0].className += " profil_card_duzenlenebilir";
